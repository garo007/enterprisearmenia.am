...
class Pagesimple2 extends BaseModel implements Searchable
{

    use HasSlug, HasTranslations;
    protected $table = 'pagesimples-2';
    protected $fillable = ['page_img','page_img_mini','name','page_img_middle','page_img_top','page_img_bottom','slug','text_top','chart_text_top_id','text_middle','chart_text_middle_id','text_bottom','chart_text_bottom_id','meta_desc','keywords'];
    ...
    {
      //  $url = route('site.simples-2.showById', ['id' => $this->id, 'lang' => false]);
        $url = 'site.simples-2.showById';
