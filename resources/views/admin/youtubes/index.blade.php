    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('posts-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.youtubes.create') }}">Ավելացնել հոդված</a></p>
                    </div><!--row-->
                @endcan
                    {{--Search--}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <a href="{{ route('site.youtubes.index' ) }}"  class="btn btn-primary">Կայքում</a>
                        </div><!--row-->

                        <div class="row">
                            {{--About us page image--}}
                         <form method="post" action="{{ route('admin.youtubes.storePageSettings') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($posts as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.youtubes.edit', $item->id) }}" class="badge badge-primary">Խմբագրել</a>
                                    <form method="post" action="{{ route('admin.youtubes.destroy', $item->id) }}" class="d-inline">
                                        @method('delete')
                                        @csrf
