    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.broshyures.update', $post->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <x-forms.ckeditor name="desc[{{$localeCode}}]" value="{!! $post->getTranslation('desc', $localeCode) !!}"/>
                                            </div>
                                        </div>
                                    </div><!--row-->
