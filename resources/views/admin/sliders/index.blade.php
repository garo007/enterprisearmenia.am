    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('tags-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.sliders.create') }}">Նոր սլայդ</a></p>
                    </div><!--row-->
                @endcan
                                    ...
                                    <tbody>
                                        @foreach($posts as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.sliders.edit', $item->id) }}" class="badge badge-primary">Փոփոխել</a>
                                                    <form method="post" action="{{ route('admin.sliders.destroy', $item->id) }}" class="d-inline">
                                                        @method('delete')
                                                        @csrf
