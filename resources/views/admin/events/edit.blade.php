    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.events.update', $post->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="event_started_date" value="{{\Illuminate\Support\Carbon::parse($post->event_started_date )->format('Y-m-d\TH:i')}}" class="form-control" required>
                        </div>
