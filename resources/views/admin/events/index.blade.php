    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('posts-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.events.create') }}">Ավելացնել միջոցառում</a></p>
                    </div><!--row-->
                @endcan
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($posts as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{route('site.calendar.show',$item->id)}}"  target="_blank" class="badge badge-primary">Կայքում</a></td>
                                            <td>
                                                <a href="{{ route('admin.events.edit', $item->id) }}" class="badge badge-primary">Փոփոխել</a>
                                                <form method="post" action="{{ route('admin.events.destroy', $item->id) }}" class="d-inline">
                                                    @method('delete')
                                                    @csrf
