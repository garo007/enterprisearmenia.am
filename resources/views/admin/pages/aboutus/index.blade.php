    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('posts-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.pages.aboutus.create') }}">Ավելացնել</a></p>
                    </div><!--row-->
                @endcan
                ...
                <div class="card-body">
                    <div class="row">
                        <a href="{{ route('aboutUsOurTeam' ) }}"  class="btn btn-primary">About US Our Team Տեսնել կայքում</a>
                    </div><!--row-->
                    <div class="row">
                        <a href="{{ route('AboutUs' ) }}"  class="btn btn-primary">About US Տեսնել կայքում</a>
                    </div><!--row-->
                    ...
                    <div class="row">
                        ...
                        <form method="post" action="{{ route('admin.pages.aboutus.storePageSettings') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        @if(settings()->group('About_Us_Page_Image')->has('page_img'))
                                            ...
                                            <img  style="max-width: 118px" src="{{ showForAdminPageImage(settings()->group('About_Us_Page_Image')->get('page_img')) }}" alt="">
                                        @else
                                            {{--no-image.jpg--}}
                                ...
                                @if(settings()->group('About_Us_Page_Image')->get('page_img'))
                                    <div class="col-md-2">
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($posts as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.pages.aboutus.edit', $item->id) }}" class="badge badge-primary">Փոփոխել</a>
                                                <form method="post" action="{{ route('admin.pages.aboutus.destroy', $item->id) }}" class="d-inline">
                                                    @method('delete')
                                                    @csrf
