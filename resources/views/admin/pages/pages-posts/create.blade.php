    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.pages.pages-posts.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <div class="tab-pane fade show {{ (App::getLocale() ==  $localeCode) ? 'active' : ''}}" id="tab_{{$localeCode}}" role="{{$localeCode}}" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[{{$localeCode}}]" id="{{$localeCode}}[title]" value="" class="form-control" required />
                                    </div>
