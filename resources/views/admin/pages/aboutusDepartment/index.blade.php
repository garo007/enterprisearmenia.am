    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('tags-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.pages.aboutusDepartment.create') }}">Ավելացնել</a></p>
                    </div><!--row-->
                @endcan
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($posts as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('home', $item->slug) }}"  class="badge badge-primary">Կայքում</a></td>
                                            <td>
                                                <a href="{{ route('admin.pages.aboutusDepartment.edit', $item->id) }}" class="badge badge-primary">Փոփոխել</a>
                                                <form method="post" action="{{ route('admin.pages.aboutusDepartment.destroy', $item->id) }}" class="d-inline">
                                                    @method('delete')
                                                    @csrf
