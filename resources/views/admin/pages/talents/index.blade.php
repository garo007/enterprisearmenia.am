    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('posts-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.pages.talents.create') }}">Ավելացնել էջ</a></p>
                    </div><!--row-->
                @endcan
                    {{--Search--}}
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($posts as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('pages.talents.show', $item->slug) }}"  class="badge badge-primary">Տեսնել</a></td>
                                            <td>
                                                <a href="{{ route('admin.pages.talents.edit', $item->id) }}" class="badge badge-primary">Փոփոխել</a>
                                                <form method="post" action="{{ route('admin.pages.talents.destroy', $item->id) }}" class="d-inline">
                                                    @method('delete')
                                                    @csrf
