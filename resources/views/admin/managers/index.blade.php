    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('user-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.managers.create') }}">Նոր ներդնող</a></p>
                    </div><!--row-->
                @endcan

                    {{--Search--}}
                    <div class="card-header">Ֆիլտրել</div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary">Որոնում</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($users as $key => $user)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('admin.managers.show',$user->id) }}">Տեսնել</a>
                                    <a class="btn btn-primary" href="{{ route('admin.managers.edit',$user->id) }}">Խմբագրել</a>

                                    <form method="post" action="{{ route('admin.managers.destroy', [$user->id]) }}" style='display: inline'>
                                        @csrf
                                        @method('delete')
