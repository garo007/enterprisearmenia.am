    ...
    <main>
        ...
        <div class="container mt-n10">
            <div class="card mb-4">
                ...
                @can('posts-create')
                    <div class="card-body">
                        <p><a class="btn btn-primary" href="{{ route('admin.galleryvideos.create') }}">Ավելացնել հոդված</a></p>
                    </div><!--row-->
                @endcan
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            {{--About us page image--}}
                         <form method="post" action="{{ route('admin.galleryvideos.storePageSettings') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @if(settings()->group('Galeryvideos_Page_Imag')->has('page_img'))

                                                <img  style="max-width: 118px" src="{{ showForAdminPageImage(settings()->group('Galeryvideos_Page_Imag')->get('page_img')) }}" alt="">
                                            @else
                                    ...
                                    @if(settings()->group('Galeryvideos_Page_Imag')->get('page_img'))
                                        <div class="col-md-2">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($posts as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->name }}</td>
                                <td><a href="{{ route('galleryvideos.show',$item->id ) }}"  class="badge badge-primary">Կայքում</a></td>
                                <td>
                                    <a href="{{ route('admin.galleryvideos.edit', $item->id) }}" class="badge badge-primary">Խմբագրել</a>
                                    <form method="post" action="{{ route('admin.galleryvideos.destroy', $item->id) }}" class="d-inline">
                                        @method('delete')
                                        @csrf
